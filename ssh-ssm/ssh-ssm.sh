#!/usr/bin/env bash
# From https://github.com/elpy1/ssh-over-ssm
...
main () {
  ...
  # commenting out this check for existing ssh keys in chain - we want to create new ones
  # to avoid issues with chained keys not being the ones attempted later in the connection.
